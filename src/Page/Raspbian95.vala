...
namespace ThemeSwitcher {
    public class Raspbian95 : Gtk.Box {
        public Raspbian95 () {
	        ...
	        // logo
	        var image = new Gtk.Image.from_file("/usr/local/share/themeswitcher/raspbian95.png");
			...
			button.clicked.connect (() => {
		        try {
		        	GLib.AppInfo info = AppInfo.create_from_commandline("xfce4-terminal --title=Config --hide-menubar --hide-borders --hide-scrollbar -e \"/usr/share/ThemeSwitcher/ThemeSwitcher.sh Raspbian95\"", null, AppInfoCreateFlags.SUPPORTS_STARTUP_NOTIFICATION);
