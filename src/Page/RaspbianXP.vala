    ...
    public class RaspbianXP : Gtk.Box {
        public RaspbianXP () {
			...
			button.clicked.connect (() => {
		        try {
		        	GLib.AppInfo info = AppInfo.create_from_commandline("xfce4-terminal --title=Config --hide-menubar --hide-borders --hide-scrollbar -e \"/usr/share/ThemeTwister/ThemeTwister.sh RaspbianXP\"", null, AppInfoCreateFlags.SUPPORTS_STARTUP_NOTIFICATION);
