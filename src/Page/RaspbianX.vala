    ...
    public class RaspbianX : Gtk.Box {
        public RaspbianX () {
			...
			button.clicked.connect (() => {
		        try {
		        	GLib.AppInfo info = AppInfo.create_from_commandline("xfce4-terminal --title=Config --hide-menubar --hide-borders --hide-scrollbar -e \"/usr/share/ThemeTwister/ThemeTwister.sh RaspbianX\"", null, AppInfoCreateFlags.SUPPORTS_STARTUP_NOTIFICATION);
