...
namespace ThemeSwitcher {
    public class Nighthawk : Gtk.Box {
        public Nighthawk () {
	        ...
	        var pixbuf = new Gdk.Pixbuf.from_file("/usr/local/share/themeswitcher/nighthawk.png");
			...
			button.clicked.connect (() => {
		        try {
		        	GLib.AppInfo info = AppInfo.create_from_commandline("xfce4-terminal --title=Config --hide-menubar --hide-borders --hide-scrollbar -e \"/usr/share/ThemeSwitcher/ThemeSwitcher.sh Nighthawk\"", null, AppInfoCreateFlags.SUPPORTS_STARTUP_NOTIFICATION);
